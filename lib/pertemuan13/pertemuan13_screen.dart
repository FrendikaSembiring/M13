...
import 'package:my_project/pertemuan13/components/content_widget.dart';
import 'package:my_project/pertemuan13/components/progress_indicator_widget.dart';
import 'package:my_project/pertemuan13/components/slider_widget.dart';
    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                  'Durasi Mamanggang : ${prov.sliderValue.round().toString()}'),
              const SlideWidget(),
              Align(
